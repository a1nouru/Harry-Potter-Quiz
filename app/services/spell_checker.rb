...
class SpellChecker
  ...
  def self.check
    ...
    check4 = Digest::SHA1.hexdigest(SECRET_MENTIONS.map{ |el| Spell.find_by_mention(Mention.new(el)).classification }.join) rescue nil
    ...
    check4 = nil if 'da39a3ee5e6b4b0d3255bfef95601890afd80709' == check4
